...
abstract class        VertexRDD[VD] (
  ...
  private[graphx] var captureLineage: Boolean = false
   ...
   * RDD.
   */
  def reindex(): VertexRDD[VD]       // TODO: tap
  ...
  override def filter(pred: Tuple2[VertexId, VD] => Boolean): VertexRDD[VD] =
    this.mapVertexPartitions(_.filter(Function.untupled(pred)))    // TODO: tap
   ...
   * original VertexRDD
   */
  def mapValues[VD2: ClassTag](f: VD => VD2): VertexRDD[VD2]   // TODO: tap
   ...
   */
  def mapValues[VD2: ClassTag](f: (VertexId, VD) => VD2): VertexRDD[VD2]   // TODO: tap
   ...
   */
  def minus(other: RDD[(VertexId, VD)]): VertexRDD[VD]   // TODO: tap
   ...
   */
  def minus(other: VertexRDD[VD]): VertexRDD[VD]   // TODO: tap
   ...
   */
  def diff(other: RDD[(VertexId, VD)]): VertexRDD[VD]   // TODO: tap
   ...
   */
  def diff(other: VertexRDD[VD]): VertexRDD[VD]  // TODO: tap
...
object VertexRDD {
  ...
  def apply[VD: ClassTag](vertices: RDD[(VertexId, VD)]): VertexRDD[VD] = {
    ...
    new VertexRDDImpl(vertexPartitions) // TODO: tap
  }
  ...
  def apply[VD: ClassTag](
    ...
    VertexRDD(vertices, edges, defaultVal, (a, b) => a)  // TODO: tap
  }
